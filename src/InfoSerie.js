    ...
    return (
        <div>
            ...
            </div>
            {
                ...
                <div className='container'>
                    <h1>Editar série</h1>
                    <ReactJson src={form} theme='railscasts'/>
                    ...
                    <form>
                        ...
                        <div className='form-group'>
                            ...
                            <input type='text' value={form.comments} onChange={onChange('comments')} className='form-control' id='name' placeholder='Comentário da série'/>
                        </div>
                        <div className='form-group'>
